                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-2">
                        <div class="d-flex align-items-center gap-2">
                            <div>
                                ...
                                <p class="text-muted mb-0">Choose a client first to view and record payments in a
                                    focused view.</p>
                            </div>
                        </div>
                    </div>
                    <form action="{{ route('payments.index') }}" method="GET"
                        class="payment-client-picker-form mainForm">
                        <div class="row g-2 mb-3">
                            <div class="col-12">
                                <label for="client-select"
                                    class="form-label small lh-sm fw-semibold text-dark mb-1">Client({{
                        ...
                        <div class="d-flex align-items-center justify-content-end gap-2 mt-3">
                            <button type="button" id="btnViewPayments"
                                class="btn btn-outline-primary bg-white text-primary fw-medium px-3 py-2">
                                <i class="fas fa-list btn-icon me-1"></i> View Payments
                            </button>
                            <button type="button" id="btnViewLedger"
                                class="btn btn-outline-primary bg-white text-primary fw-medium px-3 py-2">
                                <i class="fas fa-book btn-icon me-1"></i> View Ledger
                            </button>
                            <button type="button" id="btnCreatePayment"
                                class="btn btn-outline-primary btn-primary text-white fw-medium px-4 py-2">
