    ...
    <form method="POST" action="{{ route('clients.update', $client) }}" class="client-form" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            ...
            <div>
                ...
                <input type="text" id="group_name" name="group_name" value="{{ old('group_name', $client->group_name) }}">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" id="currency" name="currency" value="{{ old('currency', $client->currency ?? 'INR') }}" required maxlength="3">
            </div>
        </div>
        ...
        <div class="form-grid">
            <div>
                ...
                <input type="text" id="gstin" name="gstin" value="{{ old('gstin', $client->billingDetail->gstin ?? '') }}">
            </div>
            <div>
            ...
            <div style="grid-column: span 2;">
                ...
                <input type="text" id="address_line_1" name="address_line_1" value="{{ old('address_line_1', $client->billingDetail->address_line_1 ?? '') }}">
            </div>
            <div>
                <label for="city">City</label>
                <input type="text" id="city" name="city" value="{{ old('city', $client->billingDetail->city ?? '') }}">
            </div>
            <div>
                <label for="state">State</label>
                <input type="text" id="state" name="state" value="{{ old('state', $client->billingDetail->state ?? '') }}">
            </div>
            <div>
                <label for="postal_code">Postal Code</label>
                <input type="text" id="postal_code" name="postal_code" value="{{ old('postal_code', $client->billingDetail->postal_code ?? '') }}">
            </div>
            <div>
                <label for="country">Country</label>
                <input type="text" id="country" name="country" value="{{ old('country', $client->billingDetail->country ?? 'India') }}">
            </div>
        </div>
