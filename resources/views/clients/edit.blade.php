...
<h4 style="margin-bottom: 1rem; border-bottom: 1px solid var(--line); padding-bottom: 0.5rem;">Client Details</h4>
        <div class="form-grid">
            ...
            <div>
                ...
                <input type="text" id="country" name="country" value="{{ old('country', $client->country ?? 'India') }}" maxlength="100">
            </div>
            <div>
                <label for="state">State</label>
                <input type="text" id="state" name="state" value="{{ old('state', $client->state) }}" maxlength="100">
            </div>
            <div>
                <label for="city">City</label>
                <input type="text" id="city" name="city" value="{{ old('city', $client->city) }}" maxlength="100">
            </div>
            <div>
...
<h4 style="margin-top: 1.5rem; margin-bottom: 1rem; border-bottom: 1px solid var(--line); padding-bottom: 0.5rem;">Billing Details</h4>
        ...
        <div class="form-grid" id="new-billing-fields" style="margin-top: 1rem;">
            ...
            <div>
                ...
                <input type="text" id="billing_city" name="billing_city" value="{{ old('billing_city', $client->billingDetail->city ?? '') }}">
                @error('billing_city') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div>
                <label for="billing_state">Billing State</label>
                <input type="text" id="billing_state" name="billing_state" value="{{ old('billing_state', $client->billingDetail->state ?? '') }}">
                @error('billing_state') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div>
                <label for="billing_postal_code">Billing Postal Code</label>
                <input type="text" id="billing_postal_code" name="billing_postal_code" value="{{ old('billing_postal_code', $client->billingDetail->postal_code ?? '') }}">
                @error('billing_postal_code') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div>
                <label for="billing_country">Billing Country</label>
                <input type="text" id="billing_country" name="billing_country" value="{{ old('billing_country', $client->billingDetail->country ?? 'India') }}">
