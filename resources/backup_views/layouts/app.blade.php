...
<head>
    ...
    @if (request()->routeIs('payments.*', 'services.*'))
        <script>
            tailwind.config = {
                theme: {
                    extend: {
        ...
        <style>
            body.services-tailwind .app-shell input:not([type="checkbox"]):not([type="radio"]):not([type="range"]):not([type="color"]):not([type="file"]),
            body.services-tailwind .app-shell select,
            body.services-tailwind .app-shell textarea,
            body.services-tailwind .app-shell .form-control,
            body.services-tailwind .app-shell .form-select {
            ...
            body.services-tailwind .app-shell .panel-card,
            body.services-tailwind .app-shell .data-table,
            body.services-tailwind .app-shell .table-x,
            body.services-tailwind .app-shell .service-panel-card {
...
<body class="app-shell {{ request()->routeIs('services.*') ? 'services-tailwind' : '' }}">
